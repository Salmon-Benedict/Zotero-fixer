  ...
  (with-output-to-string
    (lambda ()
      ...
      (printf "Applied ~a across ~a (of ~a total).\n"
              ...
              n)
      (printf "Only container-title capitalization and DOI-URL formatting are corrected\n")
      (printf "automatically. A work's own title is never auto-corrected -- sentence-casing\n")
      (printf "it can silently lowercase real proper nouns (see the flagged report). That,\n")
